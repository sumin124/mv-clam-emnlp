...
class Stage1DM(LightningDataModule):
    def __init__(
        ...
        num_workers = 0,
        batch_size = 256,
        root = '/data/project/moleculeText/3D-MoLM/data_provider/ChEBI20',
        text_max_len = 128,
        pad_to_multiple = 8,
        dictionary=None,
        tokenizer=None,
        ...
        if args.mode == 'pretrain':
            root = '/0415_project/data_preprocess/PubChem_MAT' #### MAT 2d dataset
            ...
            root = '/3d-MoLM/0415_project/data_preprocess/PubChem_MAT' #### MAT 2d dataset
